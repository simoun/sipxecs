...
public class PermissionsResource extends UserResource {
    ...
    public void storeRepresentation(Representation entity) throws ResourceException {
        ...
        if (nameString != null) {
            ...
            try {
                ...
                // supposedly calling addCallPermission on existing call Permission object updates the object properties
                m_permissionManager.addCallPermission(permission);
            }
            catch (Exception exception) {
    ...
    public void removeRepresentations() throws ResourceException {
        ...
        if (nameString != null) {
            ...
            m_permissionManager.removeCallPermissions(Collections.singletonList(permission.getId()));
